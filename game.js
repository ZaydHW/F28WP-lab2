class Bee {
    constructor(beeNumber) {
        ...
        this.display = function() {
            //adjustposition of bee and display it
...
function makeBees() {
    ...
    if(isNaN(nbBees)) {//checkthat the input field contains a valid number
    ...
    while(i <= nbBees) {
        var num = i;
        var bee = newBee(num);//create object and its IMG element
...
function moveBees() {
    ...
    speed = document.getElementById("speedBees").value;
...
function start() {
    ...
    makeBees();
    //take start time
    document.addEventListener("keydown",lastStingTime = new Date(),false);
}
